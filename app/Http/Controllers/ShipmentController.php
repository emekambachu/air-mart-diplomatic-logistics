...
class ShipmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Mail::send('emails.new-shipment', $data, static function($message) use ($data){
            $message->from('info@airmartlogistics.com', 'Air Mart Diplomatic Cargo and Logistics');
            $message->to($data['receiver_email'], $data['receiver_name']);
            $message->replyTo('info@airmartlogistics.com', 'Air Mart Diplomatic Cargo and Logistics');
    ...
    public function activateShipment(Request $request, $id)
    {
        ...
        Mail::send('emails.verify-shipment', $data, static function ($message) use ($data) {
            ...
            $message->replyTo('Info@cargobaselogistics.com', 'Air Mart Diplomatic Cargo and Logistics');
